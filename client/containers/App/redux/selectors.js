...
const makeSelectUserAccessToken = () =>
  createSelector(selectToken, globalState =>
    globalState.get('userInfo').get('accessToken')
  );

const makeSelectUserIndustryType = () =>
  createSelector(selectToken, globalState =>
    globalState.get('userInfo').get('industryType')
  );
